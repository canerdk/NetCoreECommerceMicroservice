...
namespace Order.Domain.AggregateModels.BuyerAggregate
{
    public class Buyer : BaseEntity, IAggregateRoot
    {
            ...
            string securityNumber, string cardHolderName, DateTime expiration, Guid orderId)
        {
            ...
            {
                AddDomainEvents(new BuyerAndPaymentMethodVerifiedDomainEvent(this, existingPayment, orderId));
            ...
            AddDomainEvents(new BuyerAndPaymentMethodVerifiedDomainEvent(this, payment, orderId));
